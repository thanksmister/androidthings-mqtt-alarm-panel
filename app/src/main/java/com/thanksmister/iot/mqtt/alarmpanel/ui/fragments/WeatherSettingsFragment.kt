...
class WeatherSettingsFragment : PreferenceFragmentCompat(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    @Deprecated("We don't use this for Android Things")
    ...
    @Deprecated("Not used for Android Things")
    ...
    /*private fun setUpLocationMonitoring() {
        ...
        if (isAdded) {
            (activity as BaseActivity).showProgressDialog(getString(R.string.progress_location), false)
